            ...
            <table style ="margin-left:20px;" class="css-serial">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="titikdua">:</td>
                  <td class="isi">{{ucwords($pengajuan1->data_mitra->sts_prk) }}</td>
                </tr>
                <tr>
                  <td > </td>
                  <td class="nomor">.</td>
            ...
            <table style ="margin-left:20px;">
              <tbody>
                ...
                <tr>
                  ...
                  <td class="titikdua">:</td>
                  <td class="isi">{{ucwords($pengajuan1->data_mitra->data_ush->bank) }}</td>
                </tr>
                <tr>
                  <td > </td>
                  <td width="20px">1. </td>
