    ...
    <div class="book">
      <div class="page">
        ...
        <p class ="justify"> Adapun permohonan  kami  tersebut  untuk&emsp;keperluan  investasi / modal usaha sebesar </br>
            {{ $pengajuan1->formatRupiah('bsr_pinjaman') }} ( {{ ucwords(Terbilang::angka($pengajuan1->bsr_pinjaman)) }} )  
        ...
        <table style ="margin-left:20px; page-break-after: always;">
          <tbody>
            <tr>
              ...
              <td class="titikdua">:</td>
              <td class="isi">{{ucwords($pengajuan1->data_mitra->data_ush->nama_ush) }}</td>
            </tr>
            <tr>
              <td > </td>
              <td width="20px">1. </td>
              ...
              <td class="titikdua">:</td>
              <td class="isi">{{ucwords($pengajuan1->data_mitra->data_ush->akta_ush) }}</td>
            </tr>
            <tr>
              <td > </td>
              <td width="20px">2. </td>
              ...
              <td class="titikdua">:</td>
              <td class="isi">{{ucwords($pengajuan1->data_mitra->data_ush->izin_ush) }}</td>
            </tr>
            <tr>
              <td >B. </td>
              <td colspan=2>Bidang Usaha</td>
              <td class="titikdua">:</td>
              <td class="isi">{{ucwords($pengajuan1->data_mitra->data_ush->sektorush) }}</td>
            </tr>
            <tr>
              <td >C. </td>
              <td colspan=2>Jenis Usaha</td>
              <td class="titikdua">:</td>
              <td class="isi">{{ucwords($pengajuan1->data_mitra->data_ush->jnsush) }}</td>
            </tr>
            <tr>
              <td >D. </td>
              <td colspan=2>Berdiri Sejak</td>
              <td class="titikdua">:</td>
              <td class="isi">{{ucwords($pengajuan1->data_mitra->data_ush->thn_berdiri) }}</td>
            </tr>
            <tr>
              <td >E. </td>
              <td colspan=2>Alamat Perusahaan</td>
              <td class="titikdua">:</td>
              <td class="isi">{{ucwords($pengajuan1->data_mitra->data_ush->almt_ush) }}</td>
            </tr>
            <tr>
              <td >F. </td>
              <td colspan=2>Nomor Telepon</td>
              <td class="titikdua">:</td>
              <td class="isi">{{ucwords($pengajuan1->data_mitra->data_ush->nohp_ush) }}</td>
            </tr>
            <tr>
              <td >G. </td>
              <td colspan=2>NPWP</td>
              <td class="titikdua">:</td>
              <td class="isi">{{ucwords($pengajuan1->data_mitra->data_ush->npwp) }}</td>
            </tr>
            <tr>
              <td >H. </td>
              <td colspan=2> Tabungan Rekening Bank</td>
              <td class="titikdua">:</td>
              <td class="isi">{{strtoupper($pengajuan1->data_mitra->data_ush->bank) }}</td>
            </tr>
            <tr>
              <td > </td>
              <td width="20px">1. </td>
              ...
              <td class="titikdua">:</td>
              <td class="isi">{{strtoupper($pengajuan1->data_mitra->data_ush->bank) }} /  {{ ucwords($pengajuan1->data_mitra->data_ush->almtbank) }}</td>
            </tr>
            <tr>
              <td > </td>
              <td width="20px">2. </td>
              <td>Atas Nama</td>
              <td class="titikdua">:</td>
              <td class="isi">{{ucwords($pengajuan1->data_mitra->data_ush->atsnm) }}</td>
            </tr>
            <tr>
              <td > </td>
              <td width="20px">3. </td>
              ...
              <td class="titikdua">:</td>
              <td class="isi">{{ucwords($pengajuan1->data_mitra->data_ush->norek) }}</td>
            </tr>
          </tbody>
        </table>  
        {{-- Aset --}}
        <h4>IV. NILAI ASSET (AKTIVA) : {{ $pengajuan1->totaset }} </h4> 
