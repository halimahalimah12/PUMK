  ...
  <body>
    <div class="book">
      <div class="page">
        ...
        <table style ="margin-left:20px;  " rules="cols" >
          ...
          <tbody>
              <tr>
                ...
                <td class="isi">{{ucwords($pengajuan->data_mitra->data_ush->nama_ush) }} </td>
                <td> </td>
              </tr>
              <tr>
                <td> </td>
                <td colspan=2 class="isi">Nama Mitra B/Penanggung Jawab</td>
                <td class="isi"> {{ucwords($pengajuan->data_mitra->nm) }} </td>
                <td></td>
              </tr>
              <tr>
                <td> </td>
                <td colspan=2 class="isi">Penanggung Jawab Berikutnya</td>
                <td class="isi">{{ucwords($pengajuan->pjb->nm) }}</td>
                <td></td>
              </tr>
              <tr>
                <td align=center>B </td>
                <td colspan=2 class="isi">Alamat Usaha</td>
                <td class="isi"> {{ucwords($pengajuan->data_mitra->data_ush->almt_ush) }}</td>
                <td></td>
              </tr>
              <tr>
                <td> </td>
                <td colspan=2 class="isi">No. Telp</td>
                <td class="isi"> {{ucwords($pengajuan->data_mitra->data_ush->nohp_ush) }}</td>
                <td></td>
              </tr>
              <tr>
                <td> </td>
                <td colspan=2 class="isi">Alamat Rumah</td>
                <td class="isi"> {{ucwords($pengajuan->data_mitra->almt) }}</td>
                <td></td>
              </tr>
              <tr>
                <td> </td>
                <td colspan=2 class="isi">No. Telp</td>
                <td class="isi"> {{ucwords($pengajuan->data_mitra->no_hp) }}</td>
                <td></td>
              </tr>
              <tr>
                <td> </td>
                <td colspan=2 class="isi">Rmh. Tempat usaha Milik Sendiri/sewa</td>
                <td class="isi">{{ucwords($pengajuan->data_mitra->data_ush->tmptush) }}</td>
                <td></td>
              </tr>
              <tr>
                <td align=center>C </td>
                <td colspan=2 class="isi">Jenis Usaha</td>
                <td class="isi">{{ucwords($pengajuan->data_mitra->data_ush->jnsush) }}</td>
                <td></td>
              </tr>
              <tr>
                <td> </td>
                <td colspan=2 class="isi">Sektor Usaha</td>
                <td class="isi">{{ucwords($pengajuan->data_mitra->data_ush->sektorush) }} </td>
                <td></td>
              </tr>
              <tr>
              ...
              <tr >
                <td> </td>
                <td class="noborder" style="vertical-align: top;">15.</td>
                <td class="noborder" height="150px" style="vertical-align: top;">Kesimpulan</td>
                <td></td>
                <td></td>
              </tr>
          </tbody>
        ...
        <br>
        <br>
        <p  style="margin-right:50px;text-align:right"> ...............................................</p>
        <table style="margin-left:75px;border:none ">
          <body>
            <tr>
              <td width=150px> Yang memberikan Penjelasan Pengusaha Kecil </td>
              <td width=90px></td>
              <td  style="text-align:center; width:250px"> PT ANGKASA PURA  II (PERSERO) Petugas PKBL</td>
            </tr>
            <tr>
              <td rowspan=3></td>
              <td></td>
              <td height=35px style="vertical-align:bottom">1. ...................................................</td>
            </tr>
            <tr>
              <td></td>
              <td height=35px style="vertical-align:bottom">2. ...................................................</td>
            </tr>
            <tr>
              <td></td>
              <td height=35px style="vertical-align:bottom">3. ...................................................</td>
            </tr>
            <tr>
