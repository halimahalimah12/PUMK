                        ...
                        <div class="col-4 form-group clearfix">
                          ...
                          <div class="col-sm-12">
                            <select class="form-select " name="pddk" aria-label="Default select example">
                                <option >-  Pilih -</option>
                                <option value="SD" <?php echo e($pengajuan->pjb->pddk == "SD"  ? 'selected' : ''); ?>>SD</option>
                                <option value="SMP"<?php echo e($pengajuan->pjb->pddk == "SMP" ? 'selected' : ''); ?>>SMP</option>
                                <option value="SMA"<?php echo e($pengajuan->pjb->pddk == "SMA" ? 'selected' : ''); ?>>SMA</option>
                                <option value="D1" <?php echo e($pengajuan->pjb->pddk == "D1" ? 'selected' : ''); ?>>D1</option>
                                <option value="D1" <?php echo e($pengajuan->pjb->pddk == "D2" ? 'selected' : ''); ?>>D2</option>
                                <option value="D3" <?php echo e($pengajuan->pjb->pddk == "D3" ? 'selected' : ''); ?>>D3</option>
                                <option value="S1" <?php echo e($pengajuan->pjb->pddk == "S1" ? 'selected' : ''); ?>>S1</option>
                                <option value="S2" <?php echo e($pengajuan->pjb->pddk == "S2" ? 'selected' : ''); ?>>S2</option>
                                <option value="S3" <?php echo e($pengajuan->pjb->pddk == "S3" ? 'selected' : ''); ?>>S3</option>
                            </select>
                          </div>
                        </div>
                        <div class="col-4 form-group clearfix">
