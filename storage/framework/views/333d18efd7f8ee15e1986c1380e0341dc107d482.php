        ...
        <div class="page">
              <center> <h3> <u> Proposal Peminjaman </u></h3> </center>
                    ...
                    <table style ="margin-left:20px;">
                      <tbody>
                        <tr>
                          ...
                          <td class="titikdua">:</td>
                          <td class="isi"><?php echo e(ucwords($ush->nama_ush)); ?></td>
                        </tr>
                        <tr>
                          <td > </td>
                          <td width="20px">1. </td>
                          ...
                          <td class="titikdua">:</td>
                          <td class="isi"><?php echo e(ucwords($ush->akta_ush)); ?></td>
                        </tr>
                        <tr>
                          <td > </td>
                          <td width="20px">2. </td>
                          ...
                          <td class="titikdua">:</td>
                          <td class="isi"><?php echo e(ucwords($ush->izin_ush)); ?></td>
                        </tr>
                        <tr>
                          <td >B. </td>
                          <td colspan=2>Bidang Usaha</td>
                          <td class="titikdua">:</td>
                          <td class="isi"><?php echo e(ucwords($ush->jnsush)); ?></td>
                        </tr>
                        <tr>
                          <td >C. </td>
                        ...
                        <tr>
                          ...
                          <td class="titikdua">:</td>
                          <td class="isi"><?php echo e(ucwords($ush->thn_berdiri)); ?></td>
                        </tr>
                        <tr>
                          <td >E. </td>
                          <td colspan=2>Alamat Perusahaan</td>
                          <td class="titikdua">:</td>
                          <td class="isi"><?php echo e(ucwords($ush->almt_ush)); ?></td>
                        </tr>
                        <tr>
                          <td >F. </td>
                          <td colspan=2>Nomor Telepon</td>
                          <td class="titikdua">:</td>
                          <td class="isi"><?php echo e(ucwords($ush->nohp_ush)); ?></td>
                        </tr>
                        <tr>
                          <td >G. </td>
                          <td colspan=2>NPWP</td>
                          <td class="titikdua">:</td>
                          <td class="isi"><?php echo e(ucwords($ush->npwp)); ?></td>
                        </tr>
                        <tr>
                          <td >H. </td>
                        ...
                        <tr>
                          ...
                          <td>Atas Nama</td>
                          <td class="titikdua">:</td>
                          <td class="isi"><?php echo e(ucwords($ush->atsnm)); ?></td>
                        </tr>
                        <tr>
                          <td > </td>
                          <td width="20px">3. </td>
                          ...
                          <td class="titikdua">:</td>
                          <td class="isi"><?php echo e(ucwords($ush->norek)); ?></td>
                        </tr>
                      </tbody>
                    </table> 

                    
                    <h4>IV. NILAI ASSET (AKTIVA) : <?php echo e($pengajuan1->aset->formatRupiah('totaset')); ?> </h4> 
                    ...
                    <table  class="css-serials" border=1 >
                      ...
                      <tr>
                          <th colspan=3> Jumlah</th>
                          <td class="rp">Rp <?php echo e($totomzet); ?></th>
...
</html><?php /**PATH D:\applaravel\pumk\resources\views/dashboard/pengajuan/dokumen/cetak.blade.php ENDPATH**/ ?>