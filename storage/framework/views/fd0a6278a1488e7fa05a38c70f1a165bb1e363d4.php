          ...
          <center> <h3> <u> Proposal Peminjaman </u></h3> </center>
            ...
            <table style ="margin-left:20px;">
              <tbody>
                ...
                <tr>
                  ...
                  <td class="titikdua">:</td>
                  <td class="isi"><?php echo e(ucwords($pengajuan1->data_mitra->data_ush->bank)); ?></td>
                </tr>
                <tr>
                  <td > </td>
                  <td width="20px">1. </td>
            ...
            <table style ="margin-left:20px;" class="css-serial" >
              ...
              <?php $__currentLoopData = $manfaat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $manfaat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <td ></td>
                  <td class="nomor">.</td>
                  <td ><?php echo e($manfaat->manfaat); ?></td>
                </tr>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                
              </tbody>
            </table>
            <h4>VII. Sebagai kelengkapan proposal bersama ini kami lampirkan : </h4> 
            <table style ="margin-left:20px;" class="css-serial" >
              <tbody>
                <tr>
                  <td ></td>
            ...
            <br>
            <table style="float:right; text-align:center;page-break-after: always;">
              <body>
                <tr>
                  <td>
                  Pemohon
                ...
                <tr >
                  <td >
                  ( <?php echo e($pengajuan1->data_mitra->nm); ?> )
                  </td>
                </tr>
