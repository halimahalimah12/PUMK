    ...
    <div class="book">
      <div class="page">
        ...
        <p class ="justify"> Adapun permohonan  kami  tersebut  untuk&emsp;keperluan  investasi / modal usaha sebesar </br>
            <?php echo e($pengajuan1->formatRupiah('bsr_pinjaman')); ?> ( <?php echo e(ucwords(Terbilang::angka($pengajuan1->bsr_pinjaman))); ?> )  
        ...
        <table style ="margin-left:20px; page-break-after: always;" class="css-serial">
          <thead>
            <tr>
          ...
          <tbody>
            <tr>
              ...
              <td class="isi"><?php echo e(ucwords($pengajuan1->data_mitra->nm)); ?></td>
            </tr>
            <tr>
              <td > </td>
              <td class="nomor">.</td>
              <td class="data">Tempat Lahir </td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->data_mitra->tpt_lhr)); ?></td>
            </tr>
            <tr>
              <td > </td>
              <td class="nomor">.</td>
              <td>Tenggal Lahir </td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->data_mitra->tgl_lhr)); ?></td>
            </tr>
            <tr>
              <td > </td>
              <td class="nomor">.</td>
              <td>Jenis Kelamin</td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->data_mitra->jk)); ?></td>
            </tr>
            <tr>
              <td > </td>
              <td class="nomor">.</td>
            ...
            <tr>
              ...
              <td>Kebangsaan </td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->data_mitra->bangsa)); ?></td>
            </tr>
            <tr>
              <td > </td>
              <td class="nomor">.</td>
              <td>Alamat Rumah</td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->data_mitra->almt)); ?></td>
            </tr>
            <tr>
              <td > </td>
              <td class="nomor">.</td>
              <td>Nomor Telpon </td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->data_mitra->no_hp)); ?></td>
            </tr>
            <tr>
              <td > </td>
              <td class="nomor">.</td>
              <td>Nomor KTP</td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->data_mitra->no_ktp)); ?></td>
            </tr>
            <tr>
              <td > </td>
              <td class="nomor">.</td>
              ...
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->data_mitra->tgl_ktp)); ?></td>
            </tr>
            <tr>
              <td > </td>
              <td class="nomor">.</td>
              ...
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->data_mitra->pddk)); ?></td>
            </tr>
            <tr>
            <td > </td>
              <td class="nomor">.</td>
              <td>Kursus</td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->data_mitra->kursus)); ?></td>
            </tr>
            <tr>
              <td > </td>
              <td class="nomor">.</td>
              <td>Jabatan</td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->data_mitra->jbt)); ?></td>
            </tr> 
          </tbody>
        </table> 
        ...
        <table style ="margin-left:20px;" class="css-serial">
          ...
          <tbody>
            <tr>
              ...
              <td>Nama lengkap</td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->pjb->nm)); ?></td>
            </tr>
            <tr>
              <td > </td>
              <td class="nomor">.</td>
              <td class="data">Tempat Lahir </td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->pjb->tpt_lhr)); ?></td>
            </tr>
            <tr>
              <td > </td>
              <td class="nomor">.</td>
              <td>Tenggal Lahir </td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->pjb->tgl_lhr)); ?></td>
            </tr>
            <tr>
              <td > </td>
              <td class="nomor">.</td>
              <td> Jenis Kelamin</td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->pjb->jk)); ?></td>
            </tr>
            <tr>
              <td > </td>
              <td class="nomor">.</td>
              <td>Status hubungan dengan penanggung jawab usaha</td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->pjb->hub)); ?></td>
            </tr>
            <tr>
              <td > </td>
              <td class="nomor">.</td>
              <td>Kebangsaan </td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->pjb->bangsa)); ?></td>
            </tr>
            <tr>
              <td > </td>
              <td class="nomor">.</td>
              <td>Alamat Rumah</td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->pjb->almt)); ?></td>
            </tr>
            <tr>
              <td > </td>
              <td class="nomor">.</td>
              <td>Nomor Telpon </td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->pjb->no_hp)); ?></td>
            </tr>
            <tr>
              <td > </td>
              <td class="nomor">.</td>
              <td>Nomor KTP</td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->pjb->no_ktp)); ?></td>
            </tr>
            <tr>
              <td > </td>
              <td class="nomor">.</td>
              <td>Tanggal dikeluarkan </td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->pjb->tgl_ktp)); ?></td>
            </tr>
            <tr>
              <td > </td>
              <td class="nomor">.</td>
              <td>Pendidikan terakhir/Umum</td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->pjb->pddk)); ?></td>
            </tr>
            <tr>
            <td > </td>
              <td class="nomor">.</td>
              ...
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->pjb->kursus)); ?></td>
            </tr>
            <tr>
              <td > </td>
              <td class="nomor">.</td>
              ...
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->pjb->jbt)); ?></td>
            </tr> 
          </tbody>
        </table> 
        ...
        <table style ="margin-left:20px; page-break-after: always;">
          <tbody>
            <tr>
              ...
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->data_mitra->data_ush->nama_ush)); ?></td>
            </tr>
            <tr>
              <td > </td>
              <td width="20px">1. </td>
              ...
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->data_mitra->data_ush->akta_ush)); ?></td>
            </tr>
            <tr>
              <td > </td>
              <td width="20px">2. </td>
              ...
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->data_mitra->data_ush->izin_ush)); ?></td>
            </tr>
            <tr>
              <td >B. </td>
              <td colspan=2>Bidang Usaha</td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->data_mitra->data_ush->sektorush)); ?></td>
            </tr>
            <tr>
              <td >C. </td>
              <td colspan=2>Jenis Usaha</td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->data_mitra->data_ush->jnsush)); ?></td>
            </tr>
            <tr>
              <td >D. </td>
              <td colspan=2>Berdiri Sejak</td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->data_mitra->data_ush->thn_berdiri)); ?></td>
            </tr>
            <tr>
              <td >E. </td>
              <td colspan=2>Alamat Perusahaan</td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->data_mitra->data_ush->almt_ush)); ?></td>
            </tr>
            <tr>
              <td >F. </td>
              <td colspan=2>Nomor Telepon</td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->data_mitra->data_ush->nohp_ush)); ?></td>
            </tr>
            <tr>
              <td >G. </td>
              <td colspan=2>NPWP</td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->data_mitra->data_ush->npwp)); ?></td>
            </tr>
            <tr>
              <td >H. </td>
              <td colspan=2> Tabungan Rekening Bank</td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(strtoupper($pengajuan1->data_mitra->data_ush->bank)); ?></td>
            </tr>
            <tr>
              <td > </td>
              <td width="20px">1. </td>
              ...
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(strtoupper($pengajuan1->data_mitra->data_ush->bank)); ?> /  <?php echo e(ucwords($pengajuan1->data_mitra->data_ush->almtbank)); ?></td>
            </tr>
            <tr>
              <td > </td>
              <td width="20px">2. </td>
              <td>Atas Nama</td>
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->data_mitra->data_ush->atsnm)); ?></td>
            </tr>
            <tr>
              <td > </td>
              <td width="20px">3. </td>
              ...
              <td class="titikdua">:</td>
              <td class="isi"><?php echo e(ucwords($pengajuan1->data_mitra->data_ush->norek)); ?></td>
            </tr>
          </tbody>
        </table>  
        
        <h4>IV. NILAI ASSET (AKTIVA) : <?php echo e($pengajuan1->totaset); ?> </h4> 
        ...
        <table  class="css-serials" border=1 >
          ...
          <tbody>
            ...
            <tr>
              ...
              <th class="titikdua">:</th>
              <td class="rp"><?php echo e($pengajuan1->aset->formatRupiah('totaset')); ?></td>
            </tr>
          </tbody>
        </table> 
        ...
        <table  class="css-serials" border=1 >
          ...
          <tbody>
            <?php $__currentLoopData = $alat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                <td class="nomor">.</td>
                <td class="isi"><?php echo e(ucwords( $alt->nm_brg)); ?></td>
                <td class="isi"><?php echo e($alt->formatRupiah('hrg_satuan')); ?></td>
                <td class="isi"><?php echo e($alt->formatRupiah('jmlh')); ?></td>
              </tr>
        ...
        <table  class="css-serials"   border=1 style="page-break-after: always;">
          ...
          <tbody>
            <?php $__currentLoopData = $tenaga; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tng): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                <td class="nomor">.</td>
                <td class="isi"><?php echo e(ucwords( $tng->nm_tngk)); ?></td>
                <td class="isi"><?php echo e(ucwords( $tng->jbt )); ?></td>
                <td class="isi"><?php echo e($tng->formatRupiah('gaji')); ?></td>
              </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <tr>
              <th colspan=3> Jumlah</th>
        ...
        <table style ="margin-left:20px;" class="css-serials" >
          <tbody>
            ...
            <tr>
              ...
              <th class="titikdua">:</th>
              <td class="rp"><?php echo e($pengajuan1->oprasional->formatRupiah('totop')); ?></td>
            </tr>
          </tbody>
        </table> 
        ...
        <table  class="css-serials" border=1 >
          ...
          <tbody>
            <?php $__currentLoopData = $omzet; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $omz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                <td class="nomor">.</td>
                <td class="isi"><?php echo e(ucwords( $omz->nm_brg)); ?></td>
                <td class="isi"> <?php echo e($omz->formatRupiah('hrg_satuan')); ?></td>
                <td class="isi" ><?php echo e($omz->formatRupiah('jmlh')); ?></td>
              </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              <tr>
                <th colspan=3> Jumlah</th>
        ...
        <table class="css-serials" border=1>
          ...
          <tbody>
            <tr style =" border: 1px solid;">
              <td class="nomor"></td>
              <td class="isi">Investasi</td>
              <td class="isi"><?php echo e($pengajuan1->formatRupiah('investasi')); ?> </td>
            </tr>
            <tr style =" border: 1px solid;">
              <td class="nomor"></td>
              <td class="isi">Modal Usaha</td>
              <td class="isi"><?php echo e($pengajuan1->formatRupiah('modal')); ?></td>
            </tr>
            <tr style =" border: 1px solid;">
              <th colspan=2> Jumlah</th>
              <td class="rp"><?php echo e($pengajuan1->formatRupiah('bsr_pinjaman')); ?> </td>
            </tr>
          </tbody>
        </table>
        ...
        <table style ="margin-left:20px;" class="css-serial" >
          <tbody>
            <?php $__currentLoopData = $manfaat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $manfaat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                <td ></td>
                <td class="nomor">.</td>
                <td ><?php echo e(ucfirst($manfaat->manfaat)); ?></td>
              </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </tbody>
        </table>
...
</html><?php /**PATH D:\applaravel\pumk\resources\views/dashboard/pengajuan/dokumen/cetak_id.blade.php ENDPATH**/ ?>